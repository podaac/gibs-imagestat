# Contributing to gibs-imagestat

Thank you for contributing to gibs-imagestat!
...
The easiest way to get help or ask a question regarding gibs-imagestat is in 
the EOSDIS Slack #gibs-imagestat channel, or by asking a question 
...
of gibs-imagestat that produced this bug and specific error messages.
...
gibs-imagestat maintains a [changelog](CHANGELOG.md). See 
...
gibs-imagestat follows PEP8 as much as possible. Reference the [pylint](.pylintrc) and 
...
gibs-imagestat uses [Numpy docstrings](https://numpydoc.readthedocs.io/en/latest/format.html). 
